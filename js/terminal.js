...
const COMMANDS = {
  ...
  projects: () => [
    `1. AshGuard — women-safety app, 200+ users · [live](https://enchantress-ashguard.vercel.app/) · [code](${LINKS.github}/ASHGUARD)`,
    `2. Lost & Found Community Platform — MERN · [live](https://lost-and-find-ytbs.vercel.app/) · [code](${LINKS.github}/lost-and-find)`,
    '3. Real-time Water & Planar Reflections — C++ / DirectX 12 / HLSL, Wasp3D engine',
    `4. DirectX 12 Procedural Mesh Renderer — C++ / Win32 / HLSL · [code](${LINKS.github}/Cube_by_dx12)`,
    `5. Gemini Function-Calling Agents — Node + Gemini 2.5 Flash · [code](${LINKS.github}/gen-ai)`,
